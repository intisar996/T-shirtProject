...
import { ProductOnSale } from '../layout/productInfo';
...
export class OnSale extends Component {
    ...
    static defaultProps = {
        ...
        Popular_TShirts: 'On Sale T-Shirts',
                            ...
                            <div className='col-12 d-flex justify-content-center prod'>
                                <div className='popularBox'>
                                    <div className='row'>
                                        ...
                                        {ProductOnSale.map((product) => (
                                            <li className='col-6 col-sm-6 col-md-3 popular_card'>
